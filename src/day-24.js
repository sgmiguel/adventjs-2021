...
const countDecorations = bigTree => !bigTree ? 0 : bigTree.value + countDecorations(bigTree.left) + countDecorations(bigTree.right)
const checkIsSameTree = (treeA, treeB) => countDecorations(treeA) === countDecorations(treeB)

export default checkIsSameTree